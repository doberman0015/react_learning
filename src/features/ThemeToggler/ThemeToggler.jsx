...
export const ThemeToggler = () => {
    ...
    const onChangeHandler = (e) => {
        ...
        const updatedTheme = isChecked ? 'lidht' : 'dark';
    ...
    return (
        <div className={cls.switchWrapper}>
            <label className={cls.switch} htmlFor="switch">
                <input id="switch" type="checkbox" className={cls.circle} onChange={onChangeHandler} checked={theme === 'lidht'} />
                <svg
                viewBox="0 0 384 512"
                xmlns="http://www.w3.org/2000/svg"
                className={`${cls.moon} ${cls.svg}`}
                >
